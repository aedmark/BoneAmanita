...
class TestSomaticMeasures(unittest.TestCase):
    def test_a_reply_that_is_all_thinking_is_not_obedience(self):
        ...
        m = audit_somatic.measure("<think>Orient. Breathe.</think>", True)
