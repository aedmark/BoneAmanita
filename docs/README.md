...
**3. Ignite the Engine** Clone this repository, install the dependencies, and run the main script.
...
**Inline Telemetry Toggles:**
You can append these tags to any message to instantly change the HUD density:

- `[VSL_DEEP]` - Renders the full 13-coordinate semantic lattice.
- `[VSL_CORE]` - Renders core metabolic metrics only.
- `[VSL_LITE]` - Returns to the Spartan HP/Stamina view.
